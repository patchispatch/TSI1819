(define (problem belkan-test1)
    ...
    (:init
        ...
        ;-----------------------------------------------------
        ; Rooms where the objects are located and 'on_floor' status
        ;-----------------------------------------------------

        (at z7 apple) (on_floor apple)
    	(at z10 rose) (on_floor rose)
    	(at z14 oscar) (on_floor oscar)
    	(at z12 book) (on_floor book)
    	(at z2 gold) (on_floor gold)
